...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AdventCollab20_Digging", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AdventCollab20_Digging", null, 320, 512);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "AdventCollab20_Digging";
		app.meta["name"] = "AdventCollab20_Digging";
